...
def forest(items):
   ...
   if "force" in items:
      print_pause("Yoda said, 'You already got the force. There is not anything more to coach you.'")
   else:
       if "lightsaver" in items:
          print_pause("Yoda said,'You are the chosen hero, then I can coach you for the force.'")
          print_pause("Now the force is be with you!!")
          items.append("force")
       else:
          print_pause("Yoda said, 'You do not look the chosen hero, then I cannot coach you at all '")
   print_pause("You go back to the original fork in the road.")
   adventure_starwars(items)
...
def volcano(items):
   ...
   if "lightsaver" in items:
       ...
       if "force" in items:
          print_pause("Then you use the force power. Now you swing down the lightsaver to Darth Vader!")
